export function SiteFooter() {
  return (
    <footer className="mt-auto border-t border-border/30">
      <div className="mx-auto flex max-w-6xl flex-col gap-3 px-6 py-12 text-left text-sm text-muted-foreground md:flex-row md:items-baseline md:justify-between md:px-10 lg:px-14">
